...
[![nbviewer](https://img.shields.io/badge/render-nbviewer-orange?logo=jupyter)](https://nbviewer.org/github/niveshreddy531/breast-cancer-detection/blob/main/Breast_Cancer_Detection.ipynb)
...
```bash
# Clone the repo
git clone https://github.com/niveshreddy531/breast-cancer-detection.git
